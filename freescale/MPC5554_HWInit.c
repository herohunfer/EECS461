...
/*
 *
 * FILE : MPC5554_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC5554 derivative needed initializations, 
 *  and all initializations for the MPC5554 boards which are supported.
...
#include "../freescale/mpc5553.h"        /* MPC55xx platform development header            */
#include "MPC5554_HWInit.h"
...
/*******************************************************/
/* MPC5554 derivative specific hardware initialization */
/*******************************************************/

/* Symbol L2SRAM_LOCATION is defined in the application linker command file (.lcf) 
   It is defined to the start of the L2SRAM of the MPC5554. 
*/
...
nofralloc
    ...
    /* MPC5554 L2SRAM initialization code                         */
...
/*******************************************************/
/* MPC5554 boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC5554DEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC5554DEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC5554 external bus
        Set up the pins
