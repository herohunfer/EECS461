 ...
 *
 * DESCRIPTION:  Contains the implementations of the generic interrupt controller handling
...
#include <mpc5553.h>         /* MPC55xx platform development header       */
...
/* The INTC vector table will be placed in RAM. 
   We will use the ".__uninitialized_intc_handlertable" name to do the placement in the
