...
/*lint -esym(752,_ctors, _dtors,usr_init,__init_cpp,__fini_cpp) */
...
/*lint -esym(752, __get_runtime_linktime_delta, __get_linktime_address, __mwerks_fixup_relocations) */
...
__asm void __init_hardware(void)
{
	/*
...
#if defined(__PPCZen__) || defined(__PPCe500__)
  mfmsr r3
  oris   r3,r3,0x0200
  mtmsr r3
#endif
...
#elif defined(__PPCZen__) || defined(__PPCe500__)  /* Generating code for the e500 or Zen */
	mflr	r30
	bl		usr_init
	mtlr	r30
#endif
...
static void AllocMoreHeaps(void)
{
	 ...
	 *	a default heap will be created the first time you call
 ...
 */
/****************************************************************************/
__asm void __flush_cache(register void *address, register unsigned int size)
{
...
with the same addressing that they would use for their own code and data.
...
code to code references to use the pc relative relocations.  In general,
this will work well for normal compiled code.  It is always possible
...
will use the Code Model to determine the appropriate modes.
 ...
 */
/***************************************************************************/
static __asm int __get_runtime_linktime_delta(void)
{
	nofralloc
 ...
 */
/***************************************************************************/
static __asm void __mwerks_fixup_relocations(void)
{
	nofralloc
 ...
 */
/***************************************************************************/
__asm extern void __init_registers(void)
{
...
entry __get_linktime_address
	...
	/* reflect their runtime values yet, r3 might not equal r4.				          */
